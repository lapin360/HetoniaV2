    ...
    if (arguments_[0] === MSFT_REPLY_TYPE.ERROR) {
        ...
        switchView(getCurrentView(), viewOnClose, 500, 500, () => {
            ...
            if(arguments_[1] === MSFT_ERROR.NOT_FINISHED) {
                // User cancelled.
                msftLoginLogger.info('Connectionn annulée par le joueur.')
                return
            }
        ...
        if (Object.prototype.hasOwnProperty.call(queryMap, 'error')) {
            switchView(getCurrentView(), viewOnClose, 500, 500, () => {
                ...
                console.log("Erreur lors de l'obtention du code d'authentification ; l'application Azure est-elle correctement enregistrée ?")
                console.log(error)
                console.log(errorDesc)
                console.log('Requête complète: ', queryMap)
                setOverlayContent(
                    error,
                    errorDesc,
                    Lang.queryJS('settings.msftLogin.okButton')
            ...
            msftLoginLogger.info("authCode acquis, poursuite de l'authentification.")
            ...
            AuthManager.addMicrosoftAccount(authCode).then(value => {
                ...
                .catch((displayableError) => {
                    ...
                    if(isDisplayableError(displayableError)) {
                        ...
                        // Uh oh.
                        msftLoginLogger.error('Erreur non pris en charge lors de la connexion: ', displayableError)
    ...
    if (arguments_[0] === MSFT_REPLY_TYPE.ERROR) {
        switchView(getCurrentView(), VIEWS.settings, 500, 500, () => {
            ...
            if(arguments_.length > 1 && arguments_[1] === MSFT_ERROR.NOT_FINISHED) {
                // User cancelled.
                msftLogoutLogger.info('Déconnexion annulée par le joueur.')
                return
            }
        ...
        msftLogoutLogger.info('Déconnexion réalisée avec succes. Uuid:', uuid)
